        ...
        <div className="formsection">
            ...
            <div className="inputf">
             ...
             <div className="inputf">
                ...
                <input className="i"   disabled={isEditable ? false : true} type="date" id="dob" name="dob"  />
                </div>
                             ...
                             <div className='gender'> 
                              ...
                              <div className=" desire">
                                 ...
                                 <div>
                                     ...
                                     <select disabled={isEditable ? false : true} className='selectskill' style={{width:"550px"}} id="skill" name="skill">
                                 ...
                                 <div>
                                    ...
                                    <select  disabled={isEditable ? false : true}className='selectskill' style={{width:"550px"}} id="package" name="package">
